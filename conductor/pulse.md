...
## 📍 Now
- Phase: build. 0.18.3+34 on main and on the phone. Branch i18n is level with 0.11.0+10 and is where language work continues.
...
- Build 34 on the phone. Tester link still on 9. Play account live, nothing uploaded.
...
- diary — meal hours, pantry cold-start fix, quarter "+", and photos on diary cards (corner provenance badge) shipped. Open: device verify, oats re-read.
