...
| T3 | mvp-build | ROUND 2 2026-08-09 — camera extraction + Dropbox sync PROVEN on-device; Drive blocked on upload-SHA-1 registration (in pulse) | Next: SHA-1 in GCP console → Drive smoke → verdict → fee → billing 3g; alpha 19 Oct |
