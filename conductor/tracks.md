...
- **mvp-build** — engine complete through sync. Proxy hardened 2026-08-21 (durable Firestore ledger, App Check, rate limit, breaker) and DEPLOYED to Cloud Run, verified end to end; privacy policy and Data Safety unwritten. Billing seam open, unstarted. → tracks/mvp-build/plan.md
