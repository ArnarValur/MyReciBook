...
| T3 | mvp-build | 2026-08-10 — logo shipped (icon + header + tab) and covers reworked to user-chosen (D11), both on the S21; Drive retry still pending | Next: Drive retry → smoke PASSED → cover-flow tests → verdict → fee → billing 3g; alpha 19 Oct |
