...
| T3 | mvp-build | 2026-08-17 — DRIVE SMOKE PASSED on the S21 (both connectors proven); Unlock why-card static; cover store-layer tests in, UI-tap tests dropped (Arnar) | Engine complete through sync; billing seam open, unstarted |
