...
- `public/screenshots/` — WebP copies; sources live in conductor/docs/MyReciBook-Screenshots/
...
- `node scripts/shots.mjs` — re-derive WebP screenshots from conductor/docs/
